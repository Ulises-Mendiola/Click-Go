                ...
                <div className="footer-columns reveal-up stagger" ref={colsRef}>
                    ...
                    <div className="footer-col footer-brand-col">
                        ...
                        <nav className="social-links" aria-label="Redes sociales">
                            <a href="#" className="social-icon glass" aria-label="Facebook"><IconFacebook /></a>
                            <a href="#" className="social-icon glass" aria-label="Instagram"><IconInstagram /></a>
                            <a href="#" className="social-icon glass" aria-label="LinkedIn"><IconLinkedIn /></a>
                        </nav>
                    </div>
                    ...
                    <div className="footer-col">
                        ...
                        <ul className="footer-contact-list" aria-label="Información de contacto">
                            ...
                            <li>
                                ...
                                <a href="https://wa.me/521XXXXXXXXXX" target="_blank" rel="noopener noreferrer">WhatsApp</a>
                            </li>
                            <li>
